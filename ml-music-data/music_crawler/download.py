'''
需要使用pip instal 以下包
lxml requests_html PyExecJS pycryptodome
其中 pycryptodome 在  Windows 下使用pip install pycryptodome linux下：pip install pycrypto
'''
...
class WanYiYun():
    def __init__(self):
        self.playlist_url='https://music.163.com/playlist?id=3218292747'#歌单地址
