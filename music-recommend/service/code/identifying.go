...
type Identifying interface {
	Generate() string
	SendCode(key, code string) error
	CheckCode(key, code string) (bool, error)
}

const (
	codeSubject = "来自sta的验证码"

	emailHtmlFmt = `<!DOCTYPE html>
<html>
<head>
            ...
            <div class="content">
                ...
                <div class="xboxcontent">
                    <div class="neirong">
                        ...
                        <p><b>%s的验证码：</b><span class="font_lightblue"><span id="yzm" data="$(captcha)" onclick="return false;" t="7" style="border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;">%s</span></span><br><span class="font_gray">(请输入该验证码完成%s，验证码10分钟内有效！)</span></p>
                        <div class="line">如果你未申请%s服务，请忽略该邮件。</div>
                    </div>
                </div>
                <b class="xbottom"><b class="xb4"></b><b class="xb3"></b><b class="xb2"></b><b class="xb1"></b></b>
                <p class="foot">如果仍有问题，请联系我们的管理员QQ: <span data="800-820-5100" onclick="return false;" t="7" style="border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;">63237777
</span></p>
            </div>
        </div>
        <style type="text/css">
