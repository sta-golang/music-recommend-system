...
// 推荐新音乐
export function _getRecommendedList() {
  return axios({
    url: "/recommend/list"
  });
}
...
export class songDetail {
  constructor(songs) {
    ...
    this.album = songs[0].title;
    this.song = songs[0].creator_names;
    this.pic = songs[0].image_url;
    this.time = formatDate(new Date(songs[0].play_time), "mm:ss");
  }
}
